...
class MyModel(nn.Module):
    def __init__(self):
        ...
        self.conv1 = PointConvNet(MLP([self.nChannel+3, 64, 128, 256]), 0.4)
        #self.conv2 = PointConvNet(MLP([3+128, 256, 512]), 1.2)
        ...
        #self.conv1 = PointConvNet(MLP([self.nChannel+3, 64, 64, 128]), 1.2)
        #self.conv2 = PointConvNet(MLP([3+128, 128, 128, 256]), 1.2)
    ...
    def forward(self, data):
        ...
        #x = torch.cat((x, torch.log10(x[:,:2])), dim=1)
